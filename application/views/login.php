    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 text-center mt-5 mb-3">
                <img src="<?= base_url('assets/img/logo.png'); ?>" class="login" style="width: 250px; height:250px;" />
                <br>

                <h3 class="text-white mt-2">Informasi Stok Barang</h3>
            ...
            <div class="col-md-4 col-sm-12 offset-md-4">
                <div class="jumbotron py-3 pt-4">
                    ...
                    <div class="form-group float-right">
                        <button type="submit" name="submit" value="submit" class="btn btn-danger text-white btn-sm">Sign In <i class="fa fa-sign-in"></i></button>
                    </div>
        ...
        <center>
            <h7 class="text-white mt-2">Jl. Akses UI No.23a, Tugu, Kec. Cimanggis, Kota Depok, Jawa Barat 16451</h4>
        </center>
