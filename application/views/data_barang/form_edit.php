...
<div class="col-md-8">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <input type="text" class="form-control form-control-sm uang <?= (form_error('stok')) ? 'is-invalid' : ''; ?>" id="stok" name="stok" placeholder="Stok" value="<?= (set_value('stok')) ? set_value('stok') : number_format($barang->stok, 0, ',', '.'); ?>">
            <div class="invalid-feedback">
